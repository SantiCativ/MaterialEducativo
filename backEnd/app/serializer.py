...
class CreateUser(serializers.ModelSerializer):
    ...
    def create(self, validated_data):  # este metodo es llamado por el metodo save
        validated_data["contrasenia"] = self.convert_hash_password(
            validated_data["contrasenia"]
        )  # obtengo un hash de la contraseña
    ...
    def convert_hash_password(
        self, contrasenia
    ):  # este metodo recibe la contraseña del diccionario valided_data y devuelve un hash
